...
parser.add_argument('--c', type=int, default=12, help='period')
parser.add_argument('--hidden_dim', type=int, default=128, help='period')
parser.add_argument('--channel_mixing', type=int, default=0, help='whether or not to mix channels before model to reduce the dimension')
parser.add_argument('--d_model', type=int, default=16, help='the number of dimension after reducing dimension')

# Patching
parser.add_argument('--d_ff', type=int, default=16, help='d_ff of Transformer')
...
parser.add_argument('--k', type=int, default=3, help='number of PDR')
parser.add_argument('--num_experts', type=int, default=3, help='number of experts')
parser.add_argument('--top_k', type=int, default=3, help='top_k experts')
parser.add_argument('--base_alpha', type=int, default=10, help='adjustment factor')
parser.add_argument('--layernorm', action='store_false', help='layernorm')
